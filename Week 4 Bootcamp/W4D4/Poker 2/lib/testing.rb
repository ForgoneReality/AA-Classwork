...
#h.cards_in_hand = [Card.new(:eight, :clubs), Card.new(:jack, :clubs), Card.new(:nine, :hearts), Card.new(:three, :hearts), Card.new(:eight, :diamonds), Card.new(:queen, :diamonds), Card.new(:queen, :spades)]
...
best_five, ranking, score, bruh = h.best_five
p bruh
